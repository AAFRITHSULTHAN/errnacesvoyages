    ...
    return (
        <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
            {kpis.map((kpi) => {
                ...
                return (
                    <Card key={kpi.label} className="relative overflow-hidden border-none bg-white/60 backdrop-blur-xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 group rounded-xl">
