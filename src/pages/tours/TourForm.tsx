...
export function TourForm() {
    ...
    const onSubmit = (values: TourFormValues) => {
        const tourData: TourPackage = {
            ...
            images: images.length > 0 ? images : ['https://source.unsplash.com/random/800x600?travel'],
        };
        ...
        <div className="space-y-6 max-w-4xl mx-auto pb-12">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-500 text-sm">Fill in the details for the tour package.</p>
                </div>
            </div>

            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit as any)} className="space-y-8 bg-white p-6 rounded-lg border border-slate-100 shadow-sm">
                        ...
                        <FormField
                            ...
                            render={({ field }: { field: any }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="e.g., Bali Paradise Escape" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }: { field: any }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type="number" min={1} {...field} onChange={(e: React.ChangeEvent<HTMLInputElement>) => field.onChange(+e.target.value)} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                    ...
                    <FormField
                        ...
                        render={({ field }: { field: any }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea placeholder="Brief overview of the tour..." className="resize-none" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <div className="flex justify-end gap-4 pt-4">
                        ...
                        <Button type="submit" className="bg-[#33A894] hover:bg-[#2c9180] text-white">
